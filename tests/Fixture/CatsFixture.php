...
class CatsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'cats_ibfk_1' => ['type' => 'foreign', 'columns' => ['breed_id'], 'references' => ['breeds', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'date_of_birth' => '2015-09-19',
            'breed_id' => 1,
            'created' => '2015-09-19 21:04:08',
            'modified' => '2015-09-19 21:04:08'
        ],
    ];
}
